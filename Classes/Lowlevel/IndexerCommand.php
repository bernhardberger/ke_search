...
namespace TeaminmediasPluswerk\KeSearch\Lowlevel;
 ...
 * @package TeaminmediasPluswerk\KeSearch\Lowlevel
 */
class IndexerCommand extends \TYPO3\CMS\Core\Controller\CommandLineController
{
    ...
    public function cli_main($argv)
    {
        ...
        switch ($task) {
            ...
            case 'startIndexing':
                ...
                $verboseMode = true;
                $cleanup = $extConf['cleanupInterval'];
                $response = $indexer->startIndexing($verboseMode, $extConf, 'CLI');
